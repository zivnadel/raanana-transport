...
const Home: NextPage = () => {
	return (
		<div className="align-center flex flex-col items-center p-5 text-center">
			<h1 className="mb-10 mt-36 text-3xl sm:text-5xl font-semibold text-primary md:mt-64">
